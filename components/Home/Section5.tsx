    ...
    >
      <div className="flex flex-col h-auto items-start gap-[44px] w-full my-[85px] px-[150px]">
        ...
        <div className="flex flex-col w-1/2 relative z-20 pb-[133px]">
          {tabs.map((tab, index) => (
            <div
              ...
              className={`group flex justify-between items-center bg-white duration-300 cursor-pointer w-full z-20 py-6 px-4 ${activeTab === index ? "bg-gray-200" : ""
                }`}
            >
              <div className="flex items-center gap-4">
                <div className={`rounded-full h-6 w-6  ${activeTab === index ? "bg-[#FF5A03]" : "bg-[#FB9B00]"
                  }`} ></div>
              ...
              <Image
                ...
                height={10}
                alt="header"
                className={`transform transition-transform duration-300 ${activeTab === index ? "rotate-90" : ""
                  }`}
              />
            </div>
          ))}

          <div className="w-full left-[90%] -top-10 absolute group flex flex-col justify-start rounded-[13px] bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] transition-colors duration-300 text-white cursor-pointer z-10 p-[10px] min-h-[475px] pl-28 py-10 gap-10">
        ...
        <div className="w-full flex justify-center items-center z-20">
          <div
            className="flex items-center justify-center cursor-pointer bg-gradient-to-l to-[#FF5A03] from-[#FAC43D]  rounded-md py-2 px-4 z-20"
          >
